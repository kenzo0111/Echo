...
class Entity {
    ...
    public Entity(String ID, String LAST_NAME, String FIRST_NAME, String MIDDLE_NAME, String ADDRESS,
            String EMAIL_ADDRESS, String CONTACT_NUMBER, int YEAR, int AGE) {
        this.ID = ID;
